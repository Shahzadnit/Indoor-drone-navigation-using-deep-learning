...
frame=(no_frame*100)/perc;
       ...
       y2=(Center_y-y1)*l+Center_y;
        ...
        ytest(1,1,TrainImgNo) = theta*(pi/180);
        ytest(1,2,TrainImgNo) = xh/1200;
...
%          ytest(1,1,TrainImgNo) = pi-theta*(pi/180);
%          ytest(1,2,TrainImgNo) = 1-xh/320;
%                 
         % filename = sprintf('./TestResults/%d.png', TrainImgNo);
...
for i=1:300
    xtest1(:,:,:,i)= xtest(:,:,:,rand_row(i));
     ytest1(1,1,i) = ytest(1,1,rand_row(i));
     ytest1(1,2,i) =  ytest(1,2,rand_row(i));
              
     
     I3=permute( xtest1(:,:,:,i),[2 1 3]);
     filename = sprintf('./TestResults_distance_1/%d.png', i);
     imwrite(I3, filename);
       
    
end

hdf5write('NewTestData_random_distance_1.h5','xtest',xtest1,'ytest',ytest1);
